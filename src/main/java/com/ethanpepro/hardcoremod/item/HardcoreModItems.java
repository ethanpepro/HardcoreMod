...
public class HardcoreModItems {
	public static final Item THERMOMETER = new Item(new FabricItemSettings().maxCount(1).group(ItemGroup.TOOLS));
	public static final Item YARN = new Item(new FabricItemSettings().maxCount(16).group(ItemGroup.MISC));
	public static final Item LEATHER_STRIPS = new Item(new FabricItemSettings().maxCount(16).group(ItemGroup.MISC));
