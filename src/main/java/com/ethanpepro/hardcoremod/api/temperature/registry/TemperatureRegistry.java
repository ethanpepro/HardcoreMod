...
public class TemperatureRegistry {
	...
	public static void registerModifier(@NotNull BaseTemperatureModifier modifier) {
	...
	@NotNull public static ImmutableMap<Identifier, BaseTemperatureModifier> getModifiers() {
